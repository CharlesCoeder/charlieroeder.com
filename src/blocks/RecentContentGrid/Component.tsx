  ...
  return (
    <div className="max-w-[1200px] mx-auto mb-24 px-8">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Posts Box */}
        <div className="border border-black/28 rounded-[48px] p-12 bg-white/30 min-h-[300px]">
          <div className="mb-6">
            <div>
              <div className="inline-block">
                <h2 className="font-lora text-[32px] text-[#424242]">{postsTitle || 'Posts'}</h2>
                <div className="h-[2px] bg-black/80 mt-2" />
              </div>
        ...
        <div className="border border-black/28 rounded-[48px] p-12 bg-white/30 min-h-[300px]">
          <div className="mb-6">
            <div>
              <div className="inline-block">
                <h2 className="font-lora text-[32px] text-[#424242]">
          ...
          {streams.docs && streams.docs.length > 0 ? (
            <div className="space-y-6">
              {streams.docs.map((stream) => (
                <div key={stream.id} className="border-b border-black/10 pb-4 last:border-b-0">
                  <Link
